(function (_, Kotlin, $module$react, $module$kotlin_extensions, $module$kotlinx_coroutines_core) {
  ...
  RBuilder.prototype.child_bzgiuu$ = function (klazz, handler) {
    return this.invoke_eb8iu4$(get_js(klazz), handler);
  };
  ...
  RBuilder.prototype.node_y6lajw$ = function (klazz, props, children) {
    if (children === void 0)
      children = emptyList();
    return this.node_rwypko$(get_js(klazz), props, children);
  };
  ...
  var get_rClass_0 = defineInlineFunction('kotlin-react.react.get_rClass_u6l5a3$', wrapFunction(function () {
    var get_js = Kotlin.kotlin.js.get_js_1yb8b7$;
    return function ($receiver) {
      return get_js($receiver);
    };
  ...
  package$react.get_rClass_u6l5a3$ = get_rClass_0;
